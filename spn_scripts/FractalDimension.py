...
#The original code (https://github.com/ChatzigeorgiouGroup/FractalDimension/tree/master) from which this was adapted has GNU General Public License v3.0. This code is adapted under a GNU General Public License.
